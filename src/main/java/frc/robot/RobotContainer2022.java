 ...
 */
public class RobotContainer2022 extends RobotContainer {
  ...
  private final ShooterSubsystem m_shooterSubsystem = new ShooterSubsystem(constants.new ShooterConstants());
  private final IntakeSubsystem m_intakeSubsystem = new IntakeSubsystem(constants.new IntakeConstants());
  private final IndexerSubsystem m_indexerSubsystem = new IndexerSubsystem(constants.new IndexerConstants());
